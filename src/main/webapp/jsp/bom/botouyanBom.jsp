...
<script type="text/javascript" src="<%=path%>/js/bom/botouyanBom.js"></script>
<script type="text/javascript" src="<%=path%>/js/layer/layer.js"></script>
</head>
<body>
		<div class="panel admin-panel">
			<div class="panel-head">
				<strong class="icon-reorder"> 布料&nbsp;●&nbsp;驳头眼</strong>
			</div>
			<div class="padding border-bottom">
				<ul class="search">
					<li>
						<button type="button" class="button border-green" id="add" onclick='add("bom_botouyanbom")'>
						...
						<button type="button" class="button border-red" id="del" onclick='del()'>
						 ...
						 <button type="button" class="button border-green" onclick='botouyanBomToJson("botouyanbom")'>
							<span class="icon-check"></span> 生成JSON
						</button>
						<button type="button" class="button border-green" onclick='botouyanDetailToJson("botouyanbom")'>
