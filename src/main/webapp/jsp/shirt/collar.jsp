...
<script type="text/javascript" src="<%=path%>/js/shirt/collar.js"></script>
<script type="text/javascript" src="<%=path%>/js/layer/layer.js"></script>
</head>
<body>
	<div class="panel admin-panel">
		<div class="panel-head">
			<strong class="icon-reorder"> 衬衫&nbsp;●&nbsp;领子</strong>
		</div>
		<div class="padding border-bottom">
			<ul class="search">
				<li>
					<button type="button" class="button border-green" id="add" onclick='add("shirt_collar")'><span class="icon-check"></span>新增	</button>
