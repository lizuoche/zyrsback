						...
						if (templateList.length > 0) {
							...
							for (var i = 0; i < templateList.length; i++) {
								...
								tabhtml += "<tr>"
										...
										+ "<td>"
										+ getInterceptedStr(
												template.breastpocket, 10)
										+ "</td>"
										+ "<td>"
										+ getInterceptedStr(template.pocket, 10)
										+ "</td>"
										+ "<td>"
										+ getInterceptedStr(template.sleeve, 10)
										+ "</td>"
										+ "<td>"
										+ getInterceptedStr(template.buttonnum,
												10)
										+ "</td>"
										+ "<td>"
										+ getInterceptedStr(template.placket,
												10)
										+ "</td>"
										+ "<td>"
										+ getInterceptedStr(template.back, 10)
										+ "</td>"
										+ "<td>"
										+ getInterceptedStr(template.botouyan,
												10)
										+ "</td>"
										+ "<td>"
										+ getInterceptedStr(template.buttoneye,
												10)
										+ "</td>"
										+ "<td>"
										+ getInterceptedStr(
												template.small_image, 10)
										+ "</td>"
										+ "<td>"
										+ getInterceptedStr(template.big_image,
												10)
										+ "</td>"
										+ "<td>"
										+ template.jsonname
										...
										+ dssid
										+ '"'
										+ ")'><span class='icon-trash-o' style='width:50px'></span>删除</a></div>"
										+ "<div class='button-group'><a class='button border-red' onclick='update("
										+ '"suit_'
										+ dssid
										+ '"'
										+ ")'><span class='icon-trash-o' style='width:50px'></span>修改</a></div>"
										+ "<div class='button-group'><a class='button border-green' onclick='suitDetailToJson("
										+ '"suit_'
										+ dssid
										+ '"'
...
function add() {
	layer.open({
		...
		content : '../action/addStyle.jsp?type=suit'
	});
}
