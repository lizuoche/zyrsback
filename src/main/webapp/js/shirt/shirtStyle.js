						...
						if (templateList.length > 0) {
							...
							for (var i = 0; i < templateList.length; i++) {
								...
								tabhtml += "<tr>"
										...
										+ "</td>"
										+ "<td>"
										+ getInterceptedStr(template.font,10)
										+ "</td>"
										+ "<td>"
										...
										+ "</td>"
										+ "<td>"
										+ getInterceptedStr(template.buttoneye,10)
										+ "</td>"
										+ "<td>"
										...
										+ "<div class='button-group'><a class='button border-green' onclick='shirtDetailToJson("
										+ '"shirt_'
										+ dssid
										+ '"'
...
function add() {
	layer.open({
		...
		content : '../action/addStyle.jsp?type=shirt'
	});
}
...
//款式配置详情生成JSON文件
function shirtDetailToJson(ids) {
