...
<script type="text/javascript" src="<%=basePath%>js/action/addBom.js"></script>
...
<body>
	<div class="bodyPop">
			<table class="table">
				...
				<tr>
					<td class="lable" ><span>Small_Image：</span></td>
					<td >
						<input type="text" readonly="readonly" id=smallimage style="width: 400px" value=""/>
				...
				<tr>
					<td class="lable" ><span>Big_Image：</span></td>
					<td >
						<input type="text" readonly="readonly" id="bigimage" style="width: 400px" value=""/>
				...
				<tr>
					<td class="lable"><span>Normal_Image：</span></td>
					<td>
						<input type="text" readonly="readonly" id="normalimage" style="width: 400px" value=""/>
