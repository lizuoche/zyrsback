						...
						if (templateList.length > 0) {
							...
							for (var i = 0; i < templateList.length; i++) {
								...
								tabhtml += "<tr>"
										...
										+ "</td>"
										+ "<td>"
										+ "<div class='button-group'><a class='button border-red' onclick='del("+ '"shirt_'+ dssid+ '"'+ ")'><span class='icon-trash-o'></span>删除</a></div>"
										+ "<div class='button-group'><a class='button border-red' onclick='update("+'"shirt_'+dssid+'"'+")'><span class='icon-trash-o'></span>修改</a></div>"
										+ "</td>" + "</tr>"
