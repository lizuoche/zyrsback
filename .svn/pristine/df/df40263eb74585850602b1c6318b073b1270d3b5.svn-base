...
<script type="text/javascript" src="<%=path%>/js/bom/tieBom.js"></script>
...
<body>
		<div class="panel admin-panel">
			...
			<div class="padding border-bottom">
				<ul class="search">
					<li>
						<button type="button" class="button border-green" id="add" onclick='add("bom_tiebom")'>
						...
						<button type="button" class="button border-red" id="del" onclick='del()'>
						 ...
						 <button type="button" class="button border-green" onclick='tieBomToJson("tiebom")'>
							<span class="icon-check"></span> 生成JSON
						</button>
						<button type="button" class="button border-green" onclick='tieDetailToJson("tiebom")'>
