...
<script type="text/javascript" src="<%=path%>/js/goods/lingdai.js"></script>
<script type="text/javascript" src="<%=path%>/js/layer/layer.js"></script>
</head>
<body>
		<div class="panel admin-panel">
			<div class="panel-head">
				<strong class="icon-reorder"> 商品&nbsp;●&nbsp;领带</strong>
			</div>
			<div class="padding border-bottom">
				<ul class="search">
					<li>
						<button type="button" class="button border-green" id="add" onclick='add("goods_tie")'>
						...
						<button type="button" class="button border-green" onclick='goodsToJson("tie")'>
							<span class="icon-check"></span> 生成JSON
						</button>
						<button type="button" class="button border-green" onclick='goodsDetailToJson("tie")'>
