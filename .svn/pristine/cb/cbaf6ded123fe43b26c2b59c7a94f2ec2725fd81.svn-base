...
<script type="text/javascript" src="<%=path%>/js/vest/collar.js"></script>
<script type="text/javascript" src="<%=path%>/js/layer/layer.js"></script>
</head>
<body>
	<div class="panel admin-panel">
		<div class="panel-head">
			<strong class="icon-reorder"> 马甲&nbsp;●&nbsp;领子</strong>
		</div>
		<div class="padding border-bottom">
			<ul class="search">
				<li>
					<button type="button" class="button border-green" id="add"
						onclick='add("vest_collar")'>
						<span class="icon-check"></span> 新增
					</button>
					<input id="type" type="hidden" value="collar"> <!-- <button type="button" class="button border-green" id="checkall">
